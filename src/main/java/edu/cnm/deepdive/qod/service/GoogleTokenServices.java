...
public class GoogleTokenServices implements ResourceServerTokenServices {
  ...
  private final AccessTokenConverter convert = new DefaultAccessTokenConverter();
  ...
  public OAuth2Authentication loadAuthentication(String accessToken)
    ...
    try {
      ...
      if (idToken != null) {
        ...
        OAuth2Request request = convert.extractAuthentication(payload).getOAuth2Request();
